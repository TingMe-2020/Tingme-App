...
export default {
  ...
  platform,
  //CUstom
  primaryColorStart: '#f02a75',
  primaryColorEnd: '#3fcce8',
  primaryColorStartAlpha1: 'rgba(240, 42, 117, 0.1)',
  primaryColorStartAlpha2: 'rgba(240, 42, 117, 0.2)',
  primaryColorEndAlpha1: 'rgba(64, 205, 233, 0.1)',
  primaryColorEndAlpha2: 'rgba(64, 205, 233, 0.2)',
  borderRadiusMedium: 10,
  borderRadiusLarge: 20,
  textColorNote: '#a7a7a7',
